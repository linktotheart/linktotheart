<template>
  <div class="hero min-h-screen bg-base-200">
    <div class="hero-content container mx-auto flex-col w-full justify-between lg:flex-row-reverse">
      <div class="flex items-center w-60 bg-base-300 h-60 rounded-full relative z-10">
        <nuxt-img src="/img/pulkit (1).png" />
        ...
        <div class="absolute -z-1">
          <svg width="156" height="156" viewBox="0 0 156 156" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill="#C778DD" mask="url(#path-1-inside-1_64_1298)" />
            <mask id="path-3-outside-2_64_1298" maskUnits="userSpaceOnUse" x="76.5" y="0" width="80" height="119"
              fill="black">
            ...
            <path
              ...
              fill="#C778DD" mask="url(#path-3-outside-2_64_1298)" />
          </svg>

        </div>
      </div>

      <div class="max-w-lg flex flex-col items-center lg:items-start">
        <h1 class="text-4xl font-bold">
          Pulkit is <span class="text-primary"> Web Designer </span> and <span class="text-primary"> Frontend Developer
          </span>
        </h1>
        <p class="py-6 text-center lg:text-left">
          I'm a Frontend developer & Art Director focused on digital design for
          brands that like to have fun.
        </p>
        <!-- <p class="text-sm text-gray-500 ">Working at Neotas</p> -->
        <div class="flex space-x-4 lg:space-x-6">
          <button class="btn btn-primary px-6">Contact Me</button>
          <button class="btn px-6">About Me</button>
        </div>
      </div>
    </div>
  </div>
