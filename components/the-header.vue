<template>
  <div class="navbar  z-50 sticky mx-auto top-0">
    <div class="container mx-auto max-w-3xl">
      <div class="flex-1 ">
        <a class="btn btn-ghost normal-case font-bold text-xl">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi mr-2 bi-code-slash"
            viewBox="0 0 16 16">
            <path
        ...
        <ul class="menu menu-horizontal p-0">
          ...
          <!-- <li tabindex="0">
            ...
            <ul class="p-2 bg-base-100">
              <li><nuxt-link>Submenu 1</nuxt-link></li>
